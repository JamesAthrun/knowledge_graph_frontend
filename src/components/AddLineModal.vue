<template>
  <div class="newDocuments">
    <div class="center_center">
      <el-form ref="form" :model="form" :rules="rules" class="demo-ruleForm" label-width="120px">
        ...
        <el-form-item v-if="isNew == '已有'" label="选择已有关系" style="width:422px;height:51px;">
        ...
        <el-form-item v-if="isNew == '新建'" label="name" style="width:422px;height:51px;">
          <el-input v-model="form.name" autocomplete="off"></el-input>
        </el-form-item>

        <el-form-item v-if="isNew == '新建'" label="comment" style="width:422px;height:51px;">
          <el-input v-model="form.comment" autocomplete="off"></el-input>
        </el-form-item>

        <el-form-item v-if="isNew == '新建'" label="title" style="width:422px;height:51px;">
